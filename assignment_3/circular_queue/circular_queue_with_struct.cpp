...
void dequeue() {
    ...
    cout << "Dequeued: " << queue.data[queue.front % queue.capacity] << endl;
...
void display() {
    ...
    for (int i = queue.front; i <= queue.rear; i++) {
        cout << queue.data[i % queue.capacity] << " ";
    }
    cout << "<- Rear" << endl;
}
...
void peek() {
    ...
    cout << "Front: " << queue.data[queue.front % queue.capacity] << endl;
    cout << "Rear: " << queue.data[queue.rear % queue.capacity] << endl;
}
